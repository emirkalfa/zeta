...
function displayFlightTest(stab) {
  const items = [
    { label: 'Stall Hızı', value: stab.stall_speed + ' m/s', cls: stab.stall_speed < 12 ? 'pass' : 'warn', icon: '<i class="ph ph-gauge"></i>', pct: Math.min(100, (stab.stall_speed / 20) * 100) },
    ...
    { label: 'Tırmanma Oranı', value: stab.climb_rate + ' m/s', cls: stab.climb_rate > 2 ? 'pass' : 'warn', icon: '<i class="ph ph-trend-up"></i>', pct: Math.min(100, (stab.climb_rate / 6) * 100) },
    ...
    { label: 'CL Maks', value: stab.cl_max, cls: 'pass', icon: '<i class="ph ph-trend-up"></i>', pct: Math.min(100, (stab.cl_max / 2.5) * 100) },
    ...
    { label: 'Reynolds (Re)', value: (stab.Reynolds || '').toLocaleString(), cls: 'pass', icon: '<i class="ph ph-magnifying-glass"></i>', pct: Math.min(100, ((stab.Reynolds || 0) / 500000) * 100) },
  ];
